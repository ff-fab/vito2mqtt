...
_COMMANDS: list[Command] = [
    ...
    Command("hot_water_setpoint", 0x6300, 1, "IUNON", AccessMode.READ_WRITE),
    Command("hot_water_outlet_temperature", 0x0814, 2, "IS10", AccessMode.READ),
    Command("hot_water_pump_overrun", 0x6762, 2, "IUNON", AccessMode.READ_WRITE),
    # -- Burner (8) --------------------------------------------------------
    ...
    Command("heating_curve_gradient_m1", 0x27D3, 1, "IS10", AccessMode.READ_WRITE),
    Command("heating_curve_level_m1", 0x27D4, 2, "IUNON", AccessMode.READ_WRITE),
    Command("heating_curve_gradient_m2", 0x37D3, 1, "IS10", AccessMode.READ_WRITE),
    Command("heating_curve_level_m2", 0x37D4, 2, "IUNON", AccessMode.READ_WRITE),
    # -- Room Setpoints (6) ------------------------------------------------
    Command("room_temperature_setpoint_m1", 0x2306, 1, "IUNON", AccessMode.READ_WRITE),
    Command("room_temperature_setpoint_m2", 0x3306, 1, "IUNON", AccessMode.READ_WRITE),
    Command(
    ...
    # -- Timers M1 (7) ----------------------------------------------------
    Command("timer_m1_monday", 0x2000, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m1_tuesday", 0x2008, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m1_wednesday", 0x2010, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m1_thursday", 0x2018, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m1_friday", 0x2020, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m1_saturday", 0x2028, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m1_sunday", 0x2030, 8, "CT", AccessMode.READ_WRITE),
    # -- Timers M2 (7) ----------------------------------------------------
    Command("timer_m2_monday", 0x3000, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m2_tuesday", 0x3008, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m2_wednesday", 0x3010, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m2_thursday", 0x3018, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m2_friday", 0x3020, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m2_saturday", 0x3028, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_m2_sunday", 0x3030, 8, "CT", AccessMode.READ_WRITE),
    # -- Timers Hot Water (7) ----------------------------------------------
    Command("timer_hw_monday", 0x2100, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_hw_tuesday", 0x2108, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_hw_wednesday", 0x2110, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_hw_thursday", 0x2118, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_hw_friday", 0x2120, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_hw_saturday", 0x2128, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_hw_sunday", 0x2130, 8, "CT", AccessMode.READ_WRITE),
    # -- Timers Circulation Pump (7) ---------------------------------------
    Command("timer_cp_monday", 0x2200, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_cp_tuesday", 0x2208, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_cp_wednesday", 0x2210, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_cp_thursday", 0x2218, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_cp_friday", 0x2220, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_cp_saturday", 0x2228, 8, "CT", AccessMode.READ_WRITE),
    Command("timer_cp_sunday", 0x2230, 8, "CT", AccessMode.READ_WRITE),
    # -- Frost (4) ---------------------------------------------------------
    ...
    Command("operating_mode_party_m1", 0x2303, 1, "BA", AccessMode.READ_WRITE),
    Command("operating_mode_party_m2", 0x3303, 1, "BA", AccessMode.READ_WRITE),
    # -- Switch Valve (1) --------------------------------------------------
